...
assert(
  files.healthOverview.includes("evaluateGamePublicationReadiness") &&
    files.healthOverview.includes("percentage") &&
    files.healthOverview.includes("section"),
  "El tablero global debe derivar completitud real y navegar por sección."
);
...
assert(
  files.distributionEditor.includes("Compatibilidad") &&
    files.distributionEditor.includes("maintenance") &&
    files.distributionEditor.includes("Nueva versión"),
  "Distribución debe diagnosticar coherencia y estado de fuentes."
);
assert(
