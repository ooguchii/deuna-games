...
echo "3. Confirma FFmpeg (normalmente /usr/bin/ffmpeg); lazy preview lo usa sólo para el tramo IN/OUT."
echo "4. Genera DEUNA_MEDIA_IMPORT_WORKER_TOKEN en ${ENV_TARGET}."
echo "5. Copia el mismo token a /etc/deuna-games/runtime.env."
echo "6. Ejecuta: systemctl enable --now deuna-games-media-import.service"
echo "7. Verifica: systemctl status deuna-games-media-import.service"
