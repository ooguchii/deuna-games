...
COMMENT ON CONSTRAINT editorial_items_type_check
  ...
  'Tipos editoriales admitidos: juegos, actualizaciones, identidad pública, portada, páginas institucionales, taxonomía privada y presentación de superficies públicas.';
