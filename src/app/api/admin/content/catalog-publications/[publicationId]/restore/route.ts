...
import {
  restoreGameTaxonomyPublication,
...
export async function POST(
  ...
  const target = "/admin/catalogos?seccion=publicacion";

  try {
    const result = await restoreGameTaxonomyPublication(
    ...
    console.error(
      "No se pudo restaurar la taxonomía publicada de juegos."
    );
