...
export async function POST(request: NextRequest) {
  ...
  const target =
    "/admin/paginas/presentacion?seccion=juegos";
  ...
  const parsed = publicGamesFormSchema.safeParse(
  ...
  try {
    ...
    console.error(
      "No se pudo guardar la presentación pública del catálogo."
    );
