...
export default function GameFinderUnifiedHero({
  ...
  const [setupModalRequested, setSetupModalRequested] = useState(true);
  ...
  const showSetupModal = setupModalRequested && showCpuConfirmation;

  const closeSetupModal = useCallback(() => {
    setSetupModalRequested(false);
  }, []);

  function handleDetect() {
    setCpuConfirmationRequested(true);
    setSetupModalRequested(true);
    onDetect();
  }
